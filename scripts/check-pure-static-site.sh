...
if grep -R -n -E 'node_modules|npm install|npm run|node server|tsx|vite|wxt|your-real-domain|assets/site.css' index.html privacy/index.html pay/index.html robots.txt assets/public.css assets/checkout.css assets/checkout.js; then
